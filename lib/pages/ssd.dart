...
//左侧导航菜单 build LeftCategoryNav  _getCategory
...
// _getCategory
  ...
  void _getCategory() async {
    await request('getCategory').then((val) {
      ...
      //list[0].bxMallSubDto.forEach((item) => print(item.mallSubName)); _RightCategoryNavState
    });
  }
...
class _RightCategoryNavState extends State<RightCategoryNav> {
  ...
  //得到商品列表数据 _CategoryGoodsListState int page=1
  void _getGoodList(context, String categorySubId) {
    ...
    request('getMallGoods', formData: data).then((val) {
      var data = json.decode(val.toString());
      CategoryGoodsListModel goodsList = CategoryGoodsListModel.fromJson(data);
      // Provide.value<CategoryGoodsList>(context).getGoodsList(goodsList.data); _rightInkWell
...
//商品列表，可以上拉加载 _goodsImage _getGoodList
...
class _CategoryGoodsListState extends State<CategoryGoodsList> {
  ...
  //上拉加载更多的方法 _CategoryGoodsListState CategoryGoodsList
  void _getMoreList() {
